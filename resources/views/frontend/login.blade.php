...
@section('css')
    <style>
        body {
	background: url(http://private.indocyber.pro/test/image/background.png) fixed 50% no-repeat #ececec;
}
...
form .button {																				/* Submit button */
	...
	background: linear-gradient(bottom, #4889C2 0%, #2196f3 100%);
	background: -o-linear-gradient(bottom, #4889C2 0%, #2196f3 100%);
	background: -moz-linear-gradient(bottom, #4889C2 0%, #2196f3 100%);
	background: -webkit-linear-gradient(bottom, #4889C2 0%, #2196f3 100%);
	background: -ms-linear-gradient(bottom, #4889C2 0%, #2196f3 100%);
...
<head>
    ...
    <form action="{{ route('login') }}" method="post">
        ...
        <input type="text" name="login" value="{{ old('login') }}" class="text-field" placeholder="Email or Phone" required>
