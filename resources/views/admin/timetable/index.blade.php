    ...
    <div id="input-container">
        <div class="col-12 col-sm-6">
                    <div class="input-box">
                        ...
                        <select name="subject"  id="course-title">
                ...
                <div class="col-6">
                    <div class="input-box">
                        ...
                        <select name="teacher"  id="section">
                            <option value="0">Select</option>
                    ...
                    <div class="input-box">
                        ...
                        <select name="group"  id="group">
                            ...
                            @foreach ($groups as $group)
                                <option value="{{ $group->name_n_groupe }}"> {{ $group->name_n_groupe }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
